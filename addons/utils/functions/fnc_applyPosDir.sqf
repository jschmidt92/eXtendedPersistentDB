...
if (isNil "_entity" || _array isEqualTo []) exitWith { [EGVAR(db,debug), "xpdb_utils_fnc_applyPosDir", "No entity to apply position and direction to.", true] call DEFUNC(utils,debug); };
